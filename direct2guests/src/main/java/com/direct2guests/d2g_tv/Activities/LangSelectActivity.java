...
//    }
//    public void englishFrameActivity(View view){
//        Intent i = new Intent(getBaseContext(), MainActivity.class);
//        i.putExtra(Variable.EXTRA, vdata);
//        i.putExtra(LANG_SELECT_FROM, "launcher");
////        int id = view.getId();
...
//    public void frenchFrameActivity(View view){
//        Intent i = new Intent(getBaseContext(), MainActivity.class);
//        i.putExtra(Variable.EXTRA, vdata);
//        i.putExtra(LANG_SELECT_FROM, "launcher");
////        int id = view.getId();
////        if (id == R.id.LangFrench) {
////            setLanguage("fr");
////        }
...
//    }
//
//    public void koreanFrameActivity(View view){
//        Intent i = new Intent(getBaseContext(), MainActivity.class);
//        i.putExtra(Variable.EXTRA, vdata);
//        i.putExtra(LANG_SELECT_FROM, "launcher");
////        int id = view.getId();
////        if (id == R.id.LangKorean) {
////            setLanguage("ko");
////        }
