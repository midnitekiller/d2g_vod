...
//        setHeadersTransitionOnBackEnabled(false);
        ...
        setBrandColor(ContextCompat.getColor(getActivity(), R.color.img_full_opaque));

        // Set search icon color.
        setSearchAffordanceColor(ContextCompat.getColor(getActivity(), R.color.icon_background));
